...
const manualAnswers = {
  ...
  "Кто убивает животное?": {
    summary:
      "Фрасимед ударяет тёлку топором и рассекает шейные сухожилия; затем Писистрат перерезает ей горло.",
    details:
      "Роли в обряде распределены между участниками: Стратий и Эхефрон поднимают и удерживают тёлку, Персей держит чашу для крови, Фрасимед наносит удар топором, а Писистрат завершает умерщвление. Поэтому назвать одного-единственного исполнителя было бы неточно.",
    confidence: "established",
    sourceIds: [
      "homer_odyssey_perseus_grc2",
      "de_jong_2001",
  ...
  "Что сжигают для богини?": {
    summary:
      "В этих строках Нестор срезает прядь с головы тёлки и бросает её в огонь как первый дар Афине.",
    details:
      "Текущий фрагмент описывает подготовку и умерщвление жертвенного животного, но ещё не распределение его частей. Поэтому здесь можно уверенно назвать только первую прядь; следующий этап обряда станет известен в следующем диапазоне строк.",
    confidence: "established",
    sourceIds: [
      "homer_odyssey_perseus_grc2",
      "de_jong_2001",
