...
| --------------- | ----------------------------------------------- | ----------------------------------------------------------------------------- | ---------------------- |
| Филология       | Нужна непрерывная строковая карта               | Созданы 20 диапазонов для `24.1–548`                                          | закрыто для preview    |
...
| Новый читатель  | Нужны пояснения без будущих сведений            | Добавлено 6 заметок                                                           | закрыто для preview    |
